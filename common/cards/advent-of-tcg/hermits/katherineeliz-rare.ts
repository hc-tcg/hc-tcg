	...
	constructor() {
		super({
			...
			secondary: {
				...
				damage: 80,
				power:
					'After your attack, select an empty effect slot, or one filled with armor. Increase the damage prevention by 10hp, up to 40hp damage prevented.',
			},
		})
	}
		...
		player.hooks.onAttack.add(instance, (attack) => {
			...
			game.addPickRequest({
				...
				onResult(pickResult) {
					...
					if (pickResult.slot.type !== 'effect' || rowIndex === undefined)
