...
export class CardPosModel {
	...
	/**
	 * Is this card pos abstract - meaning not pointing to a card actually on the board?
	 *
	 * If this is true, we never attempt to recalculate the card pos
	 */
	public abstract: boolean

	constructor(game: GameModel, cardPos: BasicCardPos, instance: string, abstract: boolean = false) {
		this.game = game
	...
	public get player() {
		if (!this.abstract && !this.card) this.recalculateInternalPos()
