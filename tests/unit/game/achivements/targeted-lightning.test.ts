...
describe('Test Targeted Lightning achievement', () => {
	test('"Targeted Lightning" does increase when Lightning Rod on active row', () => {
		testAchivement(
			{
	...
	test('"Targeted Lightning" counts multiple attacks as one progress', () => {
		testAchivement(
			{
				achievement: TargetedLightning,
				playerOneDeck: [GoatfatherRare, TargetBlock],
				playerTwoDeck: [EthosLabCommon, EthosLabCommon, LightningRod],
				playGame: function* (game) {
