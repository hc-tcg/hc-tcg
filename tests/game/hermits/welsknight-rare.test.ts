        ...
        testGame(
            {
                ...
                saga: function* (game) {
                    ...
                    expect(game.components.find(
                        ...
                        query.row.index(0)
                    )?.health).toBe(TinFoilChefCommon.health - WelsknightRare.secondary.damage)
                    ...
                    expect(game.components.find(
                        ...
                        query.row.currentPlayer,
                        query.row.index(0)
                    )?.health).toBe(TinFoilChefCommon.health - WelsknightRare.secondary.damage - (WelsknightRare.secondary.damage + 20/*extra damage from tfc being in yellow*/))
                    ...
                    expect(game.components.find(
                        ...
                        query.row.currentPlayer,
                        query.row.index(0)
                    )?.health).toBe(TinFoilChefCommon.health - WelsknightRare.secondary.damage - (WelsknightRare.secondary.damage + 20/*extra damage from tfc being in yellow*/) + 20 /*splash potion of healing*/ - (WelsknightRare.secondary.damage + 40 /* extra damage from tfc being in red*/ - 60 /*shield*/))
                }
            },
