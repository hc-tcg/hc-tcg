...
describe('Test Totem of Undying', () => {
		...
		testGame(
			{
				...
				playerTwoDeck: [GoodTimesWithScarRare, WelsknightCommon, Totem, TNT],
				saga: function* (game) {
		...
		testGame(
			{
				...
				playerTwoDeck: [GoodTimesWithScarRare, WelsknightCommon, Totem, Bow],
				saga: function* (game) {
					yield* playCardFromHand(game, EthosLabCommon, 'hermit', 0)
	...
	test('Test Totem with Burn', () => {
		testGame(
			{
				playerOneDeck: [GoodTimesWithScarRare, WelsknightCommon, Totem],
