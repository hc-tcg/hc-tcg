const scrappedList = [
	...
	[
		...
		'Common',
		'Health',
		"Heals player's active and AFK Hermits +20 HP.\n\nDiscard after use.",
	],
	[
		'Instant Health II',
		'Rare',
	...
	[
		...
		'Common',
		'Attack',
		'Does +40 HP damage to any opposing AFK Hermit.\n\nDiscard after use.',
	],
	[
		'Chorus Fruit',
		'Common',
	...
	[
		...
		'Common',
		'Attack',
		'Does +20 HP damage to opposing Hermit.\n\nDiscard after use.',
	],
	[
		'TNT',
		'Common',
		'Attack',
		'Does +60 HP damage to opposing Hermit. Also does +20 HP damage to user.\n\nDiscard after use.',
	],
	[
		'Crossbow',
		'Rare',
		'Attack',
		"Does +40 HP damage to opposing Hermit and +10 HP damage to AFK Hermit of player's choice.\n\nDiscard after use.",
	],
	[
		'Diamond Sword',
		'Rare',
		'Attack',
		'Does +40 HP damage to opposing Hermit.\n\nDiscard after use.',
	],
	[
		'Golden Axe',
		'Rare',
		'Attack',
		'Does +40 HP damage. Ignores any attached Effect card.\n\nDiscard after use.',
	],
	[
		'Lava Bucket',
		'Rare',
		'Attack',
		'BURNS the opposing Hermit\n\nDoes an additional +20 HP damage per turn until opponent is knocked out.\n\nGoing AFK does not eliminate the BURN. Discard after use.',
	],
	[
	...
	[
		...
		'Rare',
		'Attack',
		'Opponent takes +20 HP damage every time user is attacked until user is knocked out.\n\nDiscard after user is knocked out.',
	],
	[
		'Netherite Sword',
		'Ultra Rare',
		'Attack',
		'Does +60 HP damage to opposing Hermit.\n\nDiscard after use.',
	],
	[
		'Milk Bucket',
		'Common',
	...
	[
		...
		'Common',
		'Defense',
		'Protects from the first +20 HP damage taken.\n\nDiscard following any damage taken.',
	],
	[
		'Iron Armor',
		'Common',
	...
	[
		...
		'Common',
		'Defense',
		'Protects from the first +10 HP damage taken.\n\nDiscard following any damage taken.',
	],
	[
		'Water Bucket',
		'Common',
	...
	[
		...
		'Rare',
		'Defense',
		'Protects from the first +30 HP damage.\n\nDiscard after user is knocked out.',
	],
	[
		'Invisibility Potion',
		'Rare',
	...
	[
		...
		'Ultra Rare',
		'Defense',
		'Protects from the first +40 HP damage.\n\nDiscard after user is knocked out.',
	],
	[
		'Totem',
		'Ultra Rare',
		'Defense',
		'Player recovers +10 HP after being knocked out and remains in battle.\n\nDiscard after use.',
	],
	[
		'Composter',
		'Common',
	...
	[
		...
		'Common',
		'Hand',
		"Move 1 of active Hermit's attached item cards to any AFK Hermit.\n\nReceiving Hermit must have open item card slot.\n\nDiscard after use.",
	],
	[
		'Chest',
		'Rare',
