 ...
 * @typedef {import('common/types/pick-process').BoardPickedCardInfo} BoardPickedCardInfo
 * @typedef {import('common/types/pick-process').HandPickedCardInfo} HandPickedCardInfo
 * @typedef {import('common/types/pick-process').PickedCardInfo} PickedCardInfo
 * @typedef {import('common/types/pick-process').PickedCardsInfo} PickedCardsInfo
 */
