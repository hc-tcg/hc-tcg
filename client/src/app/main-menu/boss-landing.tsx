	...
	return (
		...
		>
			...
			<div className={css.bossRules}>
				That's right, the Hermitcraft TCG has its first boss fight! This is no challenge deck, Evil
				X cares not for the cards. He brings his own moves, and they are vicious! If you think you
				can defeat him, you'll need to bring your best game. Be sure to check your audio settings to
				...
				<br />
				EX is immune to Fire, Poison, and Slowness; and cannot be inflected upon him.
				<br />
				<br />
				The following cards don't work in this battle:
				<div>
					<CardList cards={nonFunctionalCards} wrap={true} />
				</div>
				<h1>EX's Moves & Special</h1>
				Evil X can attack for 50, 70 or 90 damage.
				<br />
				<br />
				...
				<br />
				If a special move disables EX's attack, this only prevents attack damage, being set on fire
				and damage against AFK Hermits.
				<br />
				<br />
				At the end of EX's ninth turn, even if he cannot attack, he will perform one of two special
				moves:
				<ol>
